...
public class TweetHelper {
    ...
    Twitter_Statics constants = new Twitter_Statics();
    ...
    public boolean verify_logindata(){
        ...
        {
            Log.i("(TW_ACCTOKEN)->","true");
            if (shrpref.isExist(TW_ACCTOKEN_SECRET)){

                //ok estan estos datos guardados
                Log.i("(TW_ACCTOKEN_SECRET)->","true");
                return true;
            }else{
                Log.e("(TW_ACCTOKEN_SECRET)->","false");

                return false;
            }
        }else{
            Log.e("(TW_ACCTOKEN)->","false");
